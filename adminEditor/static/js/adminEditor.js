...
document.getElementById("flexSwitchUseButton").addEventListener("change", function () {
...
document.getElementById("flexSwitchUseButton").dispatchEvent(new Event("change"));
